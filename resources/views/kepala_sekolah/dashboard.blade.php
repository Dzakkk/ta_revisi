...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/kepala/dashboard">
            ...
            <li class="nav-item">
                ...
                <ul id="Biodata-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/kepala_sekolah/dashboard/biodata">
            ...
            <li class="nav-item">
                ...
                <ul id="Pendidikan-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/kepala_sekolah/dashboard/pendidikan">
            ...
            <li class="nav-item">
                ...
                <ul id="Pangkat-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/kepala_sekolah/dashboard/pangkat">
                ...
                <li class="nav-item">
                    ...
                    <ul id="pegawai-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="/kepala_sekolah/dashboard/pegawai">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/kepala_sekolah/dashboard/keluarga">
                    <i class="bi bi-question-circle"></i>
                    <span>Keluarga</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/kepala_sekolah/dashboard/pelatihan">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/kepala_sekolah/dashboard/cuti">
